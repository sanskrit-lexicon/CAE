...
python preverb1.py slp1 ${orig}/cae/cae.txt cae_verb_filter_map.txt mwverbs1.txt cae_preverb1.txt
echo "remake cae_preverb1_deva.txt"
python preverb1.py deva ${orig}/cae/cae.txt cae_verb_filter_map.txt mwverbs1.txt cae_preverb1_deva.txt
